...
import me.limeglass.time.elements.Register;
...
public class Time extends JavaPlugin {
	...
	private String packageName = "me.limeglass.time";
	private static String prefix = "&8[&eskript-time&8] &6";
	private String nameplate = "[skript-time] ";
